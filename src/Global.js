  ...
  return (
      ...
      <div className='dt dt--fixed'>
        <div className='dtc tc pv4 bg-red shadow-5'>
          <p className='f3 f2-m f1-s fw2 black-90 mv3 grow'>Confirmed: {responseData.cases}</p>
        </div>
        <div className='dtc tc pv4 bg-green shadow-5'>
          <p className='f3 f2-m f1-s fw2 black-90 mv3 grow'>Recovered: {responseData.recovered}</p>
        </div>
        <div className='dtc tc pv4 bg-gray shadow-5'>
          <p className='f3 f2-m f1-s fw2 black-90 mv3 grow'>Deaths: {responseData.deaths}</p>
        </div>
      </div>
      </div>
  );
